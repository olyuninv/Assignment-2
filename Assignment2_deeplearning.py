...
def main():
    ...
    print("Training set (images) shape: {shape}".format(shape=train_data.train_data.shape))
    print("Training set (labels) shape: {shape}".format(shape=train_data.train_labels.shape))
    ...
    # Shapes of test set
    print("Test set (images) shape: {shape}".format(shape=test_data.test_data.shape))
    print("Test set (labels) shape: {shape}".format(shape=test_data.test_labels.shape))
    ...
    for i in range(0,10):
        label_index = target[i].item()
        label = '%i - %s' % (label_index, label_dict[label_index])
        data_labels.append(label)        

    plot_data(data, data_labels, 'GT')
